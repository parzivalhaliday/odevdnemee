...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(557.9,403.8,0.4728,0.4728);

	this.instance_1 = new lib.mcSlaytShow();
	this.instance_1.setTransform(184.05,148.35,0.3786,0.3786);
...
p.nominalBounds = new cjs.Rectangle(432.6,334.8,314.5,210.90000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/SlaytShow_atlas_1.png?1618927242629", id:"SlaytShow_atlas_1"}
	],
	preloads: []
};
