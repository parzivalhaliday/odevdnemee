...
lib.ssMetadata = [
		{name:"SlaytShow_atlas_1", frames: [[0,0,800,600],[802,0,800,600],[0,602,800,600],[0,1204,800,600],[802,602,800,600]]}
];
...
(lib._1 = function() {
	this.initialize(ss["SlaytShow_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.SlaytShow = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(410.7,300,378.7,300);
// library properties:
lib.properties = {
	id: '289CC05A51362748B33FC7F3A43ABAA7',
	width: 800,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/SlaytShow_atlas_1.png?1620286683304", id:"SlaytShow_atlas_1"}
	],
	preloads: []
};
...
an.compositions['289CC05A51362748B33FC7F3A43ABAA7'] = {
