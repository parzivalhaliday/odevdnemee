...
lib.ssMetadata = [
		{name:"Banner_atlas_1", frames: [[569,1893,383,85],[954,1893,288,85],[0,1893,567,85],[655,1806,314,85],[0,1806,653,85],[0,0,800,600],[802,0,800,600],[0,602,800,600],[0,1204,800,600],[802,602,800,600]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-95.8,-21.15,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-95.8,-21.1,191.5,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-72.1,-21.2,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-72.1,-21.2,144,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-141.85,-21.15,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-141.8,-21.1,283.5,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-78.45,-21.15,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-78.4,-21.1,157,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-163.15,-21.2,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-163.1,-21.2,326.5,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(400,209.7,0.3215,0.3215);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(99).to({_off:false},0).to({scaleX:1,scaleY:1,y:113,alpha:1},20,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({scaleX:0.1887,scaleY:0.1887,y:-21.2,alpha:0},20,cjs.Ease.get(-1)).to({_off:true},1).wait(90));

	// Metin4
	this.instance_1 = new lib.Symbol4("synched",0);
	this.instance_1.setTransform(400,-8.2,0.3396,0.3396);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(99).to({_off:false},0).to({scaleX:1,scaleY:1,y:69,alpha:1},20,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({scaleX:0.1981,scaleY:0.1981,y:221.15,alpha:0},20,cjs.Ease.get(-1)).to({_off:true},1).wait(90));

	// Metin3
	this.instance_2 = new lib.Symbol3("synched",0);
	this.instance_2.setTransform(951.25,121.35);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(49).to({_off:false},0).to({x:400,alpha:1},20,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({x:-153.25,alpha:0},20,cjs.Ease.get(-1)).to({_off:true},1).wait(140));

	// Metin2
	this.instance_3 = new lib.Symbol2("synched",0);
	this.instance_3.setTransform(-82.15,57.25);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(49).to({_off:false},0).to({x:400,alpha:1},20,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({x:888.7,alpha:0},20,cjs.Ease.get(-1)).to({_off:true},1).wait(140));

	// Metin1
	this.instance_4 = new lib.Symbol1("synched",0);
	this.instance_4.setTransform(400,-21.1);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({y:100,alpha:1},19,cjs.Ease.get(1)).wait(10).to({startPosition:0},0).to({y:225.75,alpha:0},20,cjs.Ease.get(-1)).to({_off:true},1).wait(190));

	// Slayt2
	this.instance_5 = new lib.mcMaskeliSlaytShow();
	this.instance_5.setTransform(700,100,0.3333,0.3333,0,0,0,400.1,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(149).to({x:504},20).wait(50).to({x:100},20).wait(1));

	// Slayt1
	this.instance_6 = new lib.mcMaskeliSlaytShow();
	this.instance_6.setTransform(100.05,100.05,0.3334,0.3334,0,0,0,400,300.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(149).to({x:100},0).to({x:306},20).wait(50).to({x:700},20).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(104.9,57.7,988.0000000000001,189.39999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Banner_atlas_1.png?1621500411448", id:"Banner_atlas_1"}
	],
	preloads: []
};
